...
public class DatePickerFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.dialog_date,null);//Запонили представление

        mDatePicker = (DatePicker)view.findViewById(R.id.dialog_date_picker);
        mDatePicker.init(year,month,day,null);
        return new AlertDialog.Builder(getActivity()) //Создаем экземпляр AlertDialog
                .setView(view)//назначели представление для диалогового окна
                ...
                })// устанавливаем кнопку ОК в диалоговое окно
